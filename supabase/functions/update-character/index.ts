...
const defaults = {
  version: 1, name: 'Ari', head: 'oval', body: 'trail-jacket', legs: 'trail-boots', skinTone: '#d99b72',
  hairStyle: 'short', hairColor: '#3e302b', eyeColor: '#315b63', accessory: 'trail-hat',
};
const choices = {
  head: ['round', 'oval', 'angular'], body: ['trail-jacket', 'field-vest', 'storm-coat'], legs: ['trail-boots', 'scout-pants', 'climbing-gear'],
  skinTone: ['#f2c7a5', '#e5ad83', '#d99b72', '#b97855', '#8c573f', '#5d382d'], hairStyle: ['short', 'waves', 'braids', 'mohawk', 'bun', 'bald'],
  hairColor: ['#201b1a', '#3e302b', '#75492f', '#c08b4f', '#b9513d', '#6d4b88'], eyeColor: ['#315b63', '#3f6f9d', '#4f7a4f', '#79583e', '#8d6e9f'],
  accessory: ['none', 'round-glasses', 'goggles', 'bandana', 'flower', 'trail-hat'],
} as const;
