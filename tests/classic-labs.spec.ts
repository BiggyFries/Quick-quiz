...
test('Prototype Corridor exposes and plays Labs 03 through 14 with matching deterministic state', async ({ page }) => {
  const errors: string[] = [];
  ...
  await page.screenshot({ path: path.join(captures, 'prototype-corridor-fourteen-labs.png') });
